...
// and before returning (doing nothing) below if eventualBG is undefined.
    ...
    if (typeof iob_data.lastTemp !== 'undefined' ) {
        // FIX: create new timestamp when pump resumes and there is no recent
        // temp basal commands
...
// This has to happen after we obtain iob_data
    ...
    // FIX: BG impact rounding precision
...
// Initialize and calculate variables used for predicting BGs
    ...
    // FIX: remaining peak carb impact rounding precision
...
// Begin core dosing logic: check for situations requiring low or high temps, and return appropriate temp after first match
    ...
    if (eventualBG < min_bg) { // if eventual BG is below target:
        ...
        // FIX: insulineScheduled rounding precision
        ...
        // FIX: insulineScheduled comparison rounding precision
        ...
        // FIX: temp basal rate comparison rounding precision
    ...
    if (iob_data.iob > max_iob) {
        ...
        // FIX: maxSafeBasal rounding precision
        ...
        insulinScheduled = currenttemp.duration * (currenttemp.rate - basal) / 60;
        // FIX: insulinScheduled rounding precision
        insulinScheduled = Math.round(insulinScheduled * 1000000) / 1000000;
