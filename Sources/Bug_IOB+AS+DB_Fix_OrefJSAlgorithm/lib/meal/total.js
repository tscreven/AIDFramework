...
function recentCarbs(opts, time) {
    ...
    var lastCarbTime = 0;
     // The if condition is incorrect inheritted from bug filled algorithm, but
     // is intentionally left unfixed in this patch.
    if (!treatments) {
        console.log("recentCarbs: no treatments; returning empty result at", time.toISOString());
        return {};
    }
