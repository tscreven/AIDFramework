...
//console.error("skipping:",glucose_data[i].glucose,glucose_data[i-1].glucose);
    ...
    if (typeof __appendToFile === 'function') {
        __appendToFile('temp.txt', 'Fixed autosens: ratio=' + ratio + ' rawRatio=' + rawRatio + ' newisf=' + newisf + ' sens=' + profile.sens + ' pSensitive=' + pSensitive + ' pResistant=' + pResistant + ' basalOff=' + basalOff + ' deviations=' + deviations.length);
    }
    return {
        "ratio": ratio,
        "newisf": newisf
