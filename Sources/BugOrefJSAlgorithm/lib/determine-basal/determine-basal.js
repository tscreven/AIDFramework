...
var determine_basal = function determine_basal(glucose_status, currenttemp, iob_data, profile, autosens_data, meal_data, tempBasalFunctions, microBolusAllowed, reservoir_data, currentTime, pumphistory, preferences, basalprofile, trio_custom_variables, middleWare) {
    ...
    if (tdd24h_14d_Ratio > 1) {
        ...
        console.error("LOG: imprecise tdd24h_14d_Ratio =", tdd24h_14d_Ratio);
    }
    ...
    console.error("LOG: imprecise minAgo =", minAgo);
...
//    var sensitivityRatio;
    ...
    if ( high_temptarget_raises_sensitivity && profile.temptargetSet && target_bg > normalTarget ||
        ...
        console.error("LOG: imprecise sensitivityRatio 1 =", sensitivityRatio);
    ...
    if (profile.temptargetSet && target_bg < normalTarget && dynISFenabled && BG >= target_bg) {
        if (sensitivityRatio < newRatio) {
            ...
            console.error("LOG: imprecise sensitivityRatio 2 =", sensitivityRatio);
...
// Conversely, adjust BG target based on autosens ratio if no temp target is running
    ...
    if (profile.temptargetSet) {
        ...
        if ( profile.sensitivity_raises_target && autosens_data.ratio < 1 || profile.resistance_lowers_target && autosens_data.ratio > 1 ) {
            ...
            console.error("LOG: imprecise new_target_bg =", target_bg);
        }
    }
    ...
    if (glucose_status.noise >= 2) {
        ...
        console.error("LOG: imprecise adjustedMinBG =", adjustedMinBG);
        console.error("LOG: imprecise adjustedTargetBG =", adjustedTargetBG);
        console.error("LOG: imprecise adjustedMaxBG =", adjustedMaxBG);
    }
    ...
    console.error("LOG: imprecise threshold =", threshold);
...
// Adjust ISF based on sensitivityRatio
    ...
    console.error("LOG: imprecise sens =", sens);
...
// and before returning (doing nothing) below if eventualBG is undefined.
    ...
    console.error("LOG: imprecise lastTempAge =", lastTempAge);
...
// This has to happen after we obtain iob_data
    ...
    console.error("LOG: imprecise bgi =", bgi);
    ...
    console.error("LOG: imprecise deviation =", deviation);
    ...
    console.error("LOG: imprecise eventualBG =", eventualBG);
...
// Initialize rT (requestedTemp) object. Has to be done after eventualBG is calculated.
    ...
    console.error("LOG: imprecise CR =", round(carbRatio, 1));
...
// Initialize and calculate variables used for predicting BGs
    ...
    console.error("LOG: imprecise ci =", ci);
    ...
    console.error("LOG: imprecise maxCI =", maxCI);
    if (ci > maxCI) {
    ...
    if (meal_data.carbs) {
        ...
        console.error("LOG: imprecise remainingCATime =", remainingCATime);
    ...
    console.error("LOG: imprecise remainingCIpeak =", remainingCIpeak);
    ...
    console.error("LOG: imprecise slopeFromMaxDeviation =", slopeFromMaxDeviation);
    ...
    console.error("LOG: imprecise slopeFromMinDeviation =", slopeFromMinDeviation);
    ...
    console.error("LOG: imprecise slopeFromDeviations =", slopeFromDeviations);
    ...
    try {
        iobArray.forEach(function(iobTick) {
            ...
            console.error("LOG: imprecise predBGI =", predBGI);
            var predZTBGI = round(( -iobTick.iobWithZeroTemp.activity * sens * 5 ), 2);
            console.error("LOG: imprecise predZTBGI =", predZTBGI);
            ...
            switch(true) {
                case dynISFenabled && !enable_sigmoid:
                    ...
                    console.error("LOG: imprecise IOBpredBG =", IOBpredBG);
                    ...
                    console.error("LOG: imprecise ZTpredBG =", ZTpredBG);
            ...
            console.error("LOG: imprecise remainingCI =", round(remainingCI,0));
            predCIs.push(round(predCI,0));
            console.error("LOG: imprecise remainingpredCI =", round(predCI,0));
            ...
            if(predUCI>0) {
                ...
                console.error("LOG: imprecise UAMduration =", UAMduration);
            }
            ...
            if ( COBpredBG < minCOBGuardBG ) { 
                ...
                console.error("LOG: imprecise minCOBGuardBG =", minCOBGuardBG);
            }
            if ( UAMpredBG < minUAMGuardBG ) { 
                minUAMGuardBG = round(UAMpredBG); 
                console.error("LOG: imprecise minUAMGuardBG =", minUAMGuardBG);
            }
            if ( IOBpredBG < minIOBGuardBG ) { 
                minIOBGuardBG = round(IOBpredBG); 
                console.error("LOG: imprecise minIOBGuardBG =", minIOBGuardBG);
            }
            if ( ZTpredBG < minZTGuardBG ) { 
                minZTGuardBG = round(ZTpredBG); 
                console.error("LOG: imprecise minZTGuardBG =", minZTGuardBG);
            }
            ...
            if ( IOBpredBGs.length > insulinPeak5m && (IOBpredBG < minIOBPredBG) ) { 
                ...
                console.error("LOG: imprecise minIOBPredBG =", minIOBPredBG); 
            }
            ...
            if ( (cid || remainingCIpeak > 0) && COBpredBGs.length > insulinPeak5m && (COBpredBG < minCOBPredBG) ) { 
                ...
                console.error("LOG: imprecise minCOBPredBG =", minCOBPredBG); 
            }
            ...
            if ( enableUAM && UAMpredBGs.length > 12 && (UAMpredBG < minUAMPredBG) ) { 
                ...
                console.error("LOG: imprecise minUAMPredBG =", minUAMPredBG); 
            }
    ...
    console.error("LOG: imprecise lastIOBpredBG =", lastIOBpredBG); 
    ...
    console.error("LOG: imprecise lastZTpredBG =", lastZTpredBG);
    if (meal_data.mealCOB > 0 && ( ci > 0 || remainingCIpeak > 0 )) {
        ...
        console.error("LOG: imprecise lastCOBpredBG =", lastCOBpredBG);
    ...
    if (ci > 0 || remainingCIpeak > 0) {
        if (enableUAM) {
            ...
            console.error("LOG: imprecise lastUAMpredBG =", lastUAMpredBG); 
    ...
    console.error("LOG: imprecise minPredBG =", minPredBG); 
    ...
    console.error("LOG: imprecise avgPredBG =", avgPredBG); 
    ...
    console.error("LOG: imprecise minGuardBG =", minGuardBG); 
    //console.error(minCOBGuardBG, minUAMGuardBG, minIOBGuardBG, minGuardBG);

    var minZTUAMPredBG = minUAMPredBG;
    console.error("LOG: imprecise minZTUAMPredBG =", minZTUAMPredBG);
    ...
    console.error("LOG: imprecise minPredBG 2 =", minPredBG); 
...
// Print summary variables based on predBGs etc.
    ...
    console.error("LOG: imprecise carbRatio =", rT.CR); 
    rT.target_bg=convert_bg(target_bg, profile);
    rT.current_target=round(target_bg, 0);
    console.error("LOG: imprecise current_target =", rT.current_target); 
...
// Use minGuardBG to prevent overdosing in hypo-risk situations
    ...
    if (enableSMB && minGuardBG < threshold) {
        ...
        console.error("LOG: imprecise insulinForManualBolus =", rT.insulinForManualBolus); 
...
// Calculate carbsReq (carbs required to avoid a hypo)
    ...
    console.error("LOG: imprecise carbsReq =", carbsReq); 
...
// Begin core dosing logic: check for situations requiring low or high temps, and return appropriate temp after first match
    ...
    if (bg < threshold && iob_data.iob < -profile.current_basal*overrideFactor*20/60 && minDelta > 0 && minDelta > expectedDelta) {
     ...
     // predictive low glucose suspend mode: BG is / is projected to be < threshold
        ...
        console.error("LOG: imprecise insulinForManualBolus 2 =", rT.insulinForManualBolus); 
        ...
        console.error("LOG: imprecise durationReq =", durationReq); 
    ...
    if (eventualBG < min_bg) { // if eventual BG is below target:
        ...
        console.error("LOG: imprecise insulinReq =", insulinReq);
        ...
        console.error("LOG: imprecise insulinScheduled =", insulinScheduled);
        ...
        console.error("LOG: imprecise insulinScheduled comparison =", minInsulinReq - basal*0.3);
        if (insulinScheduled < minInsulinReq - basal*0.3) {
            rT.reason += ", " + currenttemp.duration + "m@" + (currenttemp.rate).toFixed(2) + " is a lot less than needed. ";
            return tempBasalFunctions.setTempBasal(rate, 30, profile, rT, currenttemp);
        }
        console.error("LOG: imprecise temp basal rate comparison =", currenttemp.rate * 0.8);
        if (typeof currenttemp.rate !== 'undefined' && (currenttemp.duration > 5 && rate >= currenttemp.rate * 0.8)) {
            ...
            if ( rate <=0 ) {
                ...
                console.error("LOG: imprecise durationReq 2 =", durationReq);
    ...
    if (iob_data.iob > max_iob) {
        ...
        console.error("LOG: imprecise insulinReq 2 =", insulinReq);
        rT.insulinReq = insulinReq;
        //console.error(iob_data.lastBolusTime);
        // minutes since last bolus
        var lastBolusAge = round(( new Date(systemTime).getTime() - iob_data.lastBolusTime ) / 60000,1);
        console.error("LOG: imprecise lastBolusAge =", lastBolusAge);
        ...
        if (microBolusAllowed && enableSMB && bg > threshold) {
            ...
            console.error("LOG: imprecise mealInsulinReq =", mealInsulinReq);
            var maxBolus = 0;
            ...
            console.error("LOG: imprecise maxBolus =", maxBolus);
            ...
            durationReq = round(60*worstCaseInsulinReq / profile.current_basal * overrideFactor);
            console.error("LOG: imprecise durationReq 3 =", durationReq);
            ...
            // don't set an SMB zero temp longer than 60 minutes
                ...
                durationReq = round(durationReq/30)*30;
                console.error("LOG: imprecise durationReq 4 =", durationReq);
                ...
                console.error("LOG: imprecise smbLowTempReq =", smbLowTempReq);
                durationReq = 30;
            }
            ...
            console.error("LOG: imprecise nextBolusMins =", nextBolusMins);
            var nextBolusSeconds = round((SMBInterval - lastBolusAge) * 60, 0) % 60;
            console.error("LOG: imprecise nextBolusSeconds =", nextBolusSeconds);
        ...
        console.error("LOG: imprecise maxSafeBasal =", maxSafeBasal); 
